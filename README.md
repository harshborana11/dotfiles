...
you can search these in  your package manager 
```bash
...
with ags (make sure to uncomment the ags keybinds) 
```bash
...
### you should probably run this command after the setup is complete 
```bash 
